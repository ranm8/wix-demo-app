...
(function(window) {
    ...
    describe('Wix', function() {
        ...
        describe('wixTransformer', function() {
            var $location = {
                    search: jasmine.createSpy().andReturn({
                        instance: 'instance',
                        compId: 'compId',
            ...
            it('should transform a url and add wix specific parameters to it', function() {
                inject(function(wixTransformer) {
                    ...
                    expect(urlEncoder.encode).toHaveBeenCalledWith('url/to/add/wix/params/to', { instance : 'instance', compId : 'compId', origCompId : 'origCompId', 'section-url': 'section-url', cacheKiller: 'cacheKiller', target: 'target', width: 'width' });
                });
            });
        });
    });
